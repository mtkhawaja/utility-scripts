...
parser.add_argument('-t', '--target_path', default='./README.md', help='The path where the README.md will be saved.')
parser.add_argument('-s', '--source_path', default= source_template_path, help='Path to template file.')
parser.add_argument('-p', '--project_title', default='Your Project Name', help='Name of the Project.')
