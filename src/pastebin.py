...
parser.add_argument('-dk', '--dev_key', help='API Dev Key for Pastebin', default=API_DEV_KEY)
parser.add_argument('-uk', '--user_key', help='User Key for Pastebin', default=API_USER_KEY)
parser.add_argument('-de', '--dev_endpoint', help='Request endpoint.', default=DEV_ENDPOINT)
parser.add_argument('-re', '--raw_endpoint', help='Raw paste endpoint.', default=RAW_ENDPOINT)
...
create_paste_parser.add_argument('-pc', '--paste_content', help='Paste contents', type=str)
create_paste_parser.set_defaults(func=create_paste)

# parser for list command. 
list_paste_parser = subparsers.add_parser('list', help='list paste help')
list_paste_parser.add_argument('-l','--limit', help='Define the count of pastes to view.', default=50)
...
delete_paste_parser.add_argument('-pk', '--paste_key', help='Paste key for paste to be deleted.')
...
get_paste_parser.add_argument('-pk', '--paste_key', help='Paste key for paste to be viewed.')
