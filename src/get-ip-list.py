...
parser.add_argument("-p", "--partial", help = "Partial host identifier", type = str, default="mtk")
parser.add_argument("-a", "--nmap_arguments", help = "nmap Arguments", type = str, default="-sn -PE -R -v")
parser.add_argument("-d", "--dict", help = "Get dict with entry: {hostname: ip}", action='store_true')
